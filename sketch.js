...
function preload()
{
  ...
  starDisplay.addAnimation('one_star',oneStar);
  starDisplay.addAnimation('stars',twoStar);
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide2(fruit,star1,20)== true){
    star1.visible = false
    starDisplay.changeAnimation("one_star")
   }
  
   if(collide2(fruit,star2,20)== true){
    star2.visible = false
    starDisplay.changeAnimation("stars")
   }
}
